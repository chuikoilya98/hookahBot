...
#TODO: переделать на работу в админском чате
...
#def test(update: Update , context : CallbackContext) :
 #   context.bot.send_message(chat_id = adminChannel, text= 'Test')

#запускаем бота здесь, тут же храним все хендлеры
if __name__ == "__main__" :
    ...
    #хендлер для основного функционала
    ...
    #хендлер для тестирования функционала, после теста закомментировать
    #test_handler= CommandHandler('test',test)
    #dispatcher.add_handler(test_handler)
    
    logging.basicConfig(format='%(asctime)s - %(name)s - %(levelname)s - %(message)s',level=logging.INFO)

    #здесь регистрируем все хендлеры в диспетчере
